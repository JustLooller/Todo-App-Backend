...
import {AddTodo, DeleteTodo, UpdateTodo, GetTodos, MoveTodoToBin, RecoverFromBin, MarkAsDone, GetAllFromBin } from '../model/Model'
...
export class TodoController{
    ...
    public async AddTodo(req:Request, res: Response){
        ...
        if(typeof result !== null)
            return res.status(200).send({status:'success', message: 'Todo successfully added',data:result});
        else 
    ...
    public async DeleteTodo(req:Request, res: Response){
        ...
        if(typeof result !== null)
            return res.status(200).send({status:'success', message: 'Todo successfully deleted', data:result});
    ...
    public async UpdateTodo(req:Request, res: Response){
        ...
        if(typeof result !== null)
            return res.status(200).send({status:'success', message: 'Todo successfully updated',data:result});
    ...
    public async MoveToBin(req:Request, res: Response){
        ...
        if(typeof result !== null)
            return res.status(200).send({status:'success', message: 'Todo successfully moved to bin',data:result});
    ...
    public async RecoverFromBin(req:Request, res: Response){
        ...
        if(typeof result !== null)
            return res.status(200).send({status:'success', message: 'Todo successfully recovered from bin',data:result});
    ...
    public async MarkAsDone(req:Request, res: Response){
        ...
        if(typeof result !== null)
            return res.status(200).send({status:'success', message: 'Todo successfully marked as done',data:result});
    ...
    public async GetAllFromBin(req:Request, res: Response){
        const result= await GetAllFromBin(req.body.username);
        if(typeof result !== null)
            return res.status(200).send({status:'success',data:result});
        return res.send({status:'error', message: 'Something went wrong while getting todos from bin'});
    }
}